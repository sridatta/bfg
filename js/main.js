...
function nodeActive(a) {
    ...
    if (f.attributes) {
        ...
        if (image_attribute) {
            ...
            $GP.info_name.html("<div><img src=\"https://unavatar.now.sh/twitter/" + b.label  + "\" style=\"vertical-align:middle\" /> <a onmouseover=\"sigInst._core.plotter.drawHoverNode(sigInst._core.graph.nodesIndex['" + b.id + '\'])" onmouseout="sigInst.refresh()" href="http://twitter.com/' + b.label + '" target=”_blank”>' + b.label + "</a></div>");
        }
